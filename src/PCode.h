...
#define EQU stack[sp - 2] = stack[sp - 2] == stack[sp - 1]; sp--

#define DIF stack[sp - 2] = stack[sp - 2] != stack[sp - 1]; sp--

#define ET stack[sp - 2] = stack[sp - 2] && stack[sp - 1]; sp--

#define OU stack[sp - 2] = stack[sp - 2] || stack[sp - 1]; sp--

#define NO stack[sp - 1] = !stack[sp - 1]
